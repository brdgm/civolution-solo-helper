...
const cards : Card[] = [
  ...
  },
  {
    ...
    diceActions: [
      ...
      { values: [5,6], action: Action.ADVANCE_SCORING_CATEGORY, scoringCategory: ScoringCategory.PROSPERITY, count: 1 },
    ...
    diceActionsAdvanced: [
      ...
      { values: [3,4], action: Action.PLACE_STATUE },
      { values: [3,4], action: Action.PLACE_HUNTING_TOKEN },
      { values: [5,6], action: Action.ADVANCE_SCORING_CATEGORY, scoringCategory: ScoringCategory.PROSPERITY, count: 2 },
      { values: [5,6], action: Action.PLACE_HUNTING_TOKEN },
    ],
    blueDotCount: 1,
    redDotCount: 1
  ...
  },
  {
    ...
    diceActions: [
      ...
      { values: [5,6], action: Action.ADVANCE_SCORING_CATEGORY, scoringCategory: ScoringCategory.EVOLUTION, count: 1 },
      { values: [5,6], action: Action.PLACE_HUNTING_TOKEN },
    ],
    diceActionsAdvanced: [
      { values: [1,2], action: Action.PLACE_STATUE },
      ...
      { values: [5,6], action: Action.ADVANCE_SCORING_CATEGORY, scoringCategory: ScoringCategory.EVOLUTION, count: 2 },
      { values: [5,6], action: Action.PLACE_HUNTING_TOKEN },
    ],
    blueDotCount: 1,
    redDotCount: 1
  ...
  },
  {
    ...
    diceActions: [
      { values: [1,2], action: Action.PERFORM_PROCREATION },
      { values: [3,4], action: Action.ADVANCE_SCORING_CATEGORY, scoringCategory: ScoringCategory.PROSPERITY, count: 1 },
      { values: [5,6], action: Action.ADVANCE_SCORING_CATEGORY, scoringCategory: ScoringCategory.EVOLUTION, count: 1 },
    ],
    diceActionsAdvanced: [
      { values: [1,2], action: Action.PERFORM_PROCREATION },
